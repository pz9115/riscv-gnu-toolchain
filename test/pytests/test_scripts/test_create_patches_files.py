...
def test_riscv_body():
    ...
    series_name, series_url, download_links, patchworks_links, _patch_check_links = get_patch_info(url, False)
...
def test_no_patches():
    ...
    _series_name, _series_url, download_links, patchworks_links, _patch_check_links = get_patch_info(url, False)
